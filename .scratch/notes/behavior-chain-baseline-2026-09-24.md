...
> **本报告经过四轮独立审阅并据此修订**（2026-09-24）。第一轮发现两处必须修的问题——
...
> 与 6 处措辞/覆盖问题；第四轮在**机制文本的数值纪律**与**守卫判别力**上又抓到 2 处 P1 + 6 处 P2。
> 完整修订记录见 §7。**下面所有数字都取自修订后的产物**
> （四轮修完、同一棵干净树重跑，§7 有同源守卫与逐字节稳定性核验）。
>
> ⚠️ **本节计数曾与 §7 不符**（2026-09-26 更正）：原写"三轮"，而 §7 记有完整的**第四轮**
> 小节——是开头这句没跟上，不是第四轮不存在。
>
