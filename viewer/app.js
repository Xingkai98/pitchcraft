...
import { config } from './config.js?v=20260807-1';
import { createRenderer, drawPitch, renderFrame } from './renderer.js?v=20260807-1';
import { createGame } from './game.js?v=20260807-1';
import { mockEventStream } from './mock-event-stream.js?v=20260807-1';
