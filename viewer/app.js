...
import { config } from './config.js?v=20260806-8';
import { createRenderer, drawPitch, renderFrame } from './renderer.js?v=20260806-8';
import { createGame } from './game.js?v=20260806-8';
import { mockEventStream } from './mock-event-stream.js?v=20260806-8';
