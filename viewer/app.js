...
import { config } from './config.js?v=20260808-9';
import { createRenderer, drawPitch, renderFrame } from './renderer.js?v=20260808-9';
import { createGame } from './game.js?v=20260808-9';
import { mockEventStream } from './mock-event-stream.js?v=20260808-9';
import { resetMicroMotion } from './micro-motion.js?v=20260808-9';
