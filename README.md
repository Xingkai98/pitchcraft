...
|------|------|------|------|------|------|
| 主队纵深 | 18.3m [11.6–24.0] | 25.8m [17.1–31.1] | 25.9m [16.8–30.2] | 40.5m [33.2–48.3] | 引擎高于两侧，+56%（vs Metrica）～+121%（vs 主口径） |
| 紧凑度（到重心） | 12.8m [9.7–16.0] | 14.8m [11.6–18.2] | 15.2m [10.8–17.2] | 20.0m [17.9–23.2] | 不重叠，+31%（vs Metrica） |
| 两队重心间距 | 5.2m [3.2–8.3] | 6.9m [5.2–10.6] | 8.3m [6.8–10.5] | 15.1m [11.7–18.0] | 不重叠，+82%（vs Metrica） |
| 宽度 / 重心到球 | — | — | — | — | 区间重叠，仅报告 |
| 弹性（纵深随球） | Δ 0.8 | — | Δ 3.2 | Δ 13.0 | 口径产物，不作目标 |

**一个关键发现**：Metrica 的纵深（25.9m）**更接近 SkillCorner 的全点值（25.8m）而非其真检测值（18.3m）**——
...
实测：half-split 落空率 0–8.6%、LOO 2/20 场，真实侧内部高度自洽。
