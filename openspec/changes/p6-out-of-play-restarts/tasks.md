...
- [ ] O1.2 新增 HighlightOutcome::CornerAward：saved-rebound 弹开点未钳制越门线（home 攻 x>1 / away 攻 x<0）→ 角球；否则维持现有松散球
...
- [ ] O5.4 界外球掷球（边线短传 h=0）
- [ ] O5.5 出界视觉（球飞向边界钳制到边缘）；协议 h 字段支持（h 大小表示）
