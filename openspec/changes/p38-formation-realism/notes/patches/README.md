...
| **`exp89-engage-shift-3.5.patch`** | — | **`OPEN_PLAY_SHOT_ENGAGE_SHIFT` −4.3→−3.5** | ⚠️ 射门 15.71/场（L1 口径）、犯规 23.46 ∈ L1[16,30]；**仍破 3 条 L1**（进球 0.89→2.11） |
| **`exp89-engage-shift-3.0.patch`** | — | 同上 →−3.0 | ⚠️ 射门 24.82/场（**超引擎 L1 射门带 [6,11]**）、犯规 23.56 绿；**进球 →3.18 破 3 条 L1** |
